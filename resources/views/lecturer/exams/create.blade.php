                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="mt-7 flex flex-col items-start gap-3 md:flex-row md:flex-wrap md:items-center md:gap-6">
                            <label class="inline-flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
                                <input type="checkbox" name="is_published" value="1" class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 dark:border-slate-700" data-publish-toggle />
                            ...
                            <label class="hidden md:inline-flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300 md:max-w-[220px]" data-notify-toggle>
                                <input type="checkbox" name="notify_students" value="1" class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 dark:border-slate-700" />
